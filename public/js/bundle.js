...
var CategoryActions = function () {
	function CategoryActions() {
		_classCallCheck(this, CategoryActions);

		this.generateActions('getCategorySuccess', 'likeSuccess', 'followSuccess', 'getCategoryRecipesSuccess');
	}

	_createClass(CategoryActions, [{
		key: 'getCategory',
		value: function getCategory(id) {
			var _this = this;

			$.ajax('/api/categories/' + id).done(function (resp) {
				_this.actions.getCategorySuccess(resp);
			});
		}
	}, {
		key: 'getCategoryRecipes',
		value: function getCategoryRecipes(id) {
			var _this2 = this;

			$.ajax('/api/categoryrecipes/' + id).done(function (data) {
				_this2.actions.getCategoryRecipesSuccess(data);
			});
		}
	}]);
...
var HomeActions = function () {
	function HomeActions() {
		...
		this.generateActions('getCategoriesSuccess', 'getRecipesSuccess');
	}
	...
	_createClass(HomeActions, [{
		...
		value: function getRecipes() {
			...
			$.ajax({ url: '/api/recipes' }).done(function (data) {
				_this2.actions.getRecipesSuccess(data);
			});
		}
	}]);
...
},{"../alt":12,"../history":46}],9:[function(require,module,exports){
'use strict';
	...
	_createClass(ProfileRecipesActions, [{
		...
		value: function addRecipe(data) {
			...
			$.ajax({
				...
				_this.actions.addRecipeSuccess(data);
			}).fail(function (jqXhr) {
				_this.actions.addRecipeFail(jqXhr.responseJSON.message);
			});
		}
	}, {
		key: 'getRecipes',
		value: function getRecipes(userId) {
			var _this2 = this;
			...
			$.ajax({
				...
				_this2.actions.getRecipesFail(jqXhr.responseJSON.message);
			});
		}
	}, {
		key: 'getAllRecipes',
		value: function getAllRecipes(userId) {
			var _this3 = this;

			$.ajax({
				url: '/api/' + userId + '/allrecipes'
			}).done(function (data) {
				_this3.actions.getRecipesSuccess(data);
			}).fail(function (jqXhr) {
				_this3.actions.getRecipesFail(jqXhr.responseJSON.message);
			});
		}
	}]);
...
var _RecipeModalActions = require('./RecipeModalActions');

var _RecipeModalActions2 = _interopRequireDefault(_RecipeModalActions);
...
var RecipeActions = function () {
	...
	_createClass(RecipeActions, [{
		...
		key: 'updateRecipe',
		value: function updateRecipe(dataToSend) {
			var _this2 = this;
			...
			$.ajax({
				...
				_this2.actions.updateRecipeSuccess(data);
			}).fail(function (jqXhr) {
				_this2.actions.updateRecipeFail(jqXhr.responseJSON.message);
			});
		}
	}, {
		key: 'handleLike',
...
},{"../alt":12,"./RecipeModalActions":11}],11:[function(require,module,exports){
'use strict';
...
var RecipeModalActions = function () {
	function RecipeModalActions() {
		...
		this.generateActions('getCategoriesSuccess', 'handleChanges', 'handleCategoryChange', 'changeMainPhoto', 'getRecipeFromParent');
	}
...
},{"./Navbar":20,"./inc/Modal":38,"react":"react"}],14:[function(require,module,exports){
'use strict';
...
var _CategoryActions2 = _interopRequireDefault(_CategoryActions);

var _CategoryStore = require('../stores/CategoryStore');
...
var Category = function (_React$Component) {
	...
	function Category(props) {
		...
		_this.state = Object.assign(_CategoryStore2.default.getState());
	...
	_createClass(Category, [{
		...
		value: function componentDidMount() {
			...
			_CategoryActions2.default.getCategory(this.props.params.categoryId);
			_CategoryActions2.default.getCategoryRecipes(this.props.params.categoryId);
		...
		value: function render() {
			...
			recipesList = this.state.recipes.map(function (recipe) {
				var recipeImg = null;
...
},{"../actions/CategoryActions":1,"../helpers":45,"../stores/CategoryStore":49,"./inc/RecipeSmall":42,"react":"react","react-router":"react-router"}],16:[function(require,module,exports){
'use strict';
...
var Collection = function (_React$Component) {
	...
	_createClass(Collection, [{
		...
		value: function render() {
			...
			var recipesList = null;
			recipesList = this.state.collection.recipes.map(function (recipe) {
...
},{"../actions/CollectionActions":2,"../helpers":45,"../stores/CollectionStore":50,"../stores/NavbarStore":53,"./CommentForm":17,"./inc/AvatarUsername":33,"./inc/Comment":36,"./inc/LikeButton":37,"./inc/RecipeSmall":42,"react":"react","react-router":"react-router"}],17:[function(require,module,exports){
'use strict';
...
},{"../actions/CommentFormActions":3,"../helpers":45,"../stores/NavbarStore":53,"react":"react","react-router":"react-router","underscore":"underscore"}],18:[function(require,module,exports){
'use strict';
...
},{"../actions/GhimActions":4,"../stores/GhimStore":51,"../stores/NavbarStore":53,"react":"react"}],19:[function(require,module,exports){
'use strict';
...
var _RecipeMedium = require('./inc/RecipeMedium');

var _RecipeMedium2 = _interopRequireDefault(_RecipeMedium);
...
var Home = function (_React$Component) {
	...
	_createClass(Home, [{
		...
		value: function componentDidMount() {
			...
			_HomeActions2.default.getCategories();
			_HomeActions2.default.getRecipes();
		}
	}, {
		key: 'componentWillUnmount',
		value: function componentWillUnmount() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ className: 'col-sm-9 col-sm-push-3' },
							this.state.recipes.map(function (recipe) {
								return _react2.default.createElement(_RecipeMedium2.default, { recipe: recipe, location: _this2.props.location, 'class': 'recipe-medium clearfix recipe-block' });
							})
						),
						_react2.default.createElement(
							'div',
							{ className: 'sidebar-left col-sm-3 col-sm-pull-9' },
							_react2.default.createElement(
								'aside',
								{ className: 'category widget' },
								_react2.default.createElement(
									'h2',
									{ className: 'widget-tite' },
									'Chuyên mục'
								),
								_react2.default.createElement(
									'ul',
									...
									this.state.categories.map(function (category) {
										return _react2.default.createElement(
											'li',
											{ className: 'nav-item', key: category.value },
											_react2.default.createElement(
												_reactRouter.Link,
												{ className: 'nav-link', to: '/category/' + category.value },
												category.label
											)
										);
									})
...
},{"../actions/HomeActions":5,"../stores/HomeStore":52,"./inc/RecipeMedium":41,"react":"react","react-router":"react-router"}],20:[function(require,module,exports){
'use strict';
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_NavUser2.default, { userLoggedIn: userLoggedIn, userLink: userLink, avatarLink: this.state.current_user_avatar })
					)
				)
			);
		}
...
},{"../actions/NavbarActions":6,"../stores/NavbarStore":53,"./inc/NavUser":39,"react":"react","react-router":"react-router","underscore":"underscore"}],21:[function(require,module,exports){
'use strict';
...
},{"../actions/ProfileActions":7,"../stores/ProfileStore":56,"./inc/UserCover":44,"react":"react","react-router":"react-router","underscore":"underscore"}],23:[function(require,module,exports){
'use strict';
...
},{"../actions/ProfileCollectionsActions":8,"../stores/NavbarStore":53,"../stores/ProfileCollectionsStore":54,"./inc/AddCollectionButton":28,"./inc/AddCollectionModal":29,"./inc/CollectionSmall":35,"react":"react","react-router":"react-router"}],24:[function(require,module,exports){
'use strict';
...
var _RecipeModalStore = require('../stores/RecipeModalStore');

var _RecipeModalStore2 = _interopRequireDefault(_RecipeModalStore);
...
var ProfileRecipes = function (_React$Component) {
	...
	function ProfileRecipes(props) {
		...
		_this.state = Object.assign(_ProfileRecipesStore2.default.getState(), _NavbarStore2.default.getState(), _RecipeModalStore2.default.getState());
		_this.onChange = _this.onChange.bind(_this);
		return _this;
	}
	...
	_createClass(ProfileRecipes, [{
		...
		value: function render() {
			...
			var recipesList = this.state.recipes.map(function (recipe, index) {
				...
				var recipeUrl = '/recipe/' + recipe.contentId;
				var recipeDesc = _helpers2.default.trim_words(recipe.recipe.description, 17, '..');
				var recipeImg = null;

				return _react2.default.createElement(
					'div',
					{ key: recipe._id, className: 'grid-item recipe-grid-item' },
					_react2.default.createElement(
						'div',
						{ className: 'photo' },
						_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_underscore2.default.isEmpty(this.state.myInfo) && this.state.myInfo.username != this.props.params.id ? null : _react2.default.createElement(
							...
							_react2.default.createElement(_RecipeModal2.default, {
...
},{"../actions/NavbarActions":6,"../actions/ProfileRecipesActions":9,"../helpers":45,"../stores/NavbarStore":53,"../stores/ProfileRecipesStore":55,"../stores/RecipeModalStore":57,"./RecipeModal":26,"react":"react","react-helmet":82,"react-router":"react-router","react-select":87,"underscore":"underscore"}],25:[function(require,module,exports){
'use strict';
...
var _RecipeStore = require('../stores/RecipeStore');
...
var _RecipeHeaderCover = require('./inc/RecipeHeaderCover');

var _RecipeHeaderCover2 = _interopRequireDefault(_RecipeHeaderCover);
...
var _Review = require('./inc/Review');
...
var _AddedToCollection = require('./inc/AddedToCollection');

var _AddedToCollection2 = _interopRequireDefault(_AddedToCollection);
...
var Recipe = function (_React$Component) {
	...
	function Recipe(props) {
		...
		_this.state = Object.assign(_RecipeStore2.default.getState(), _RecipeModalStore2.default.getState(), _NavbarStore2.default.getState());
		_this.onChange = _this.onChange.bind(_this);
		return _this;
	}
	...
	_createClass(Recipe, [{
		...
		value: function componentDidMount() {
			...
			_RecipeModalStore2.default.listen(this.onChange);
			_NavbarStore2.default.listen(this.onChange);
			_RecipeActions2.default.getRecipe(this.props.params.recipeId);
		...
		key: 'componentWillUnmount',
		value: function componentWillUnmount() {
			_RecipeStore2.default.unlisten(this.onChange);
			_RecipeModalStore2.default.unlisten(this.onChange);
			_NavbarStore2.default.unlisten(this.onChange);
		}
	}, {
		key: 'componentWillReceiveProps',
		value: function componentWillReceiveProps(newprops) {
			_RecipeActions2.default.getRecipe(newprops.params.recipeId);
		}
	}, {
		key: 'onChange',
		value: function onChange(state) {
		...
		key: 'UpdateRecipeHandler',
		value: function UpdateRecipeHandler(event) {
			event.preventDefault();
			var dataToSend = this.state.formData;
			dataToSend = Object.assign({ id: this.state.recipe._id }, dataToSend);
		...
		value: function render() {
			...
			var imgUrl = '/images/df-img-sm.jpg';
			...
			if (typeof this.state.recipe.recipe.ingredients != 'undefined') {
				var ingredients = this.state.recipe.recipe.ingredients.split("\n");
				ingredientsList = ingredients.map(function (ingredient, index) {
					return _react2.default.createElement(
						'li',
						{ key: index },
						ingredient
			...
			if (typeof this.state.recipe.recipe.directions != 'undefined') {
				var directions = this.state.recipe.recipe.directions.split("\n");
				directionsList = directions.map(function (direction, index) {
					return _react2.default.createElement(
						'li',
						{ key: index },
			...
			return _react2.default.createElement(
				'div',
				{ className: 'Recipe recipe-detail' },
				!this.state.notGetRecipeYet && this.state.currentUserId == this.state.recipe.userId._id ? _react2.default.createElement(_RecipeModal2.default, {
					handleSubmit: this.UpdateRecipeHandler.bind(this),
					edit: '1',
					currentRecipe: this.state.recipe._id
				}) : null,
				_react2.default.createElement(_RecipeHeaderCover2.default, {
					recipePhoto: imgUrl,
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								{ className: 'primary container-fluid' },
								_react2.default.createElement(
									'div',
									{ className: 'actions row' },
									_react2.default.createElement(
										'div',
										{ className: 'like col-sm-3' },
										_react2.default.createElement(_LikeButton2.default, {
											currentUser: this.state.currentUserId,
											handleLike: this.handleLike.bind(this),
											likeState: this.state.likeState,
								...
								_react2.default.createElement(
									'section',
									{ className: 'ingredients clearfix' },
									_react2.default.createElement(
										'header',
										{ className: 'clearfix' },
										_react2.default.createElement(
										...
										_react2.default.createElement(
											'div',
											{ className: 'timing' },
											this.state.recipe.recipe.prepTime != null || this.state.recipe.recipe.cookTime != null ? _react2.default.createElement(
												'span',
												null,
												this.state.recipe.recipe.prepTime + this.state.recipe.recipe.cookTime,
												' phút ',
												_react2.default.createElement('i', { className: 'fa fa-clock-o' })
											) : null,
											this.state.recipe.recipe.numberOfServings != null ? _react2.default.createElement(
												'span',
												null,
												this.state.recipe.recipe.numberOfServings,
												' người ',
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										...
										_react2.default.createElement(
											'h2',
											null,
											_react2.default.createElement('i', { className: 'fa fa-flag-checkered' }),
											' Cách nấu'
										),
										_react2.default.createElement(
											'div',
											{ className: 'timing' },
											this.state.recipe.recipe.prepTime != null ? _react2.default.createElement(
												'span',
												null,
												'Chuẩn bị ',
												this.state.recipe.recipe.prepTime,
												' phút ',
												_react2.default.createElement('i', { className: 'fa fa-clock-o' })
											) : null,
											this.state.recipe.recipe.cookTime != null ? _react2.default.createElement(
												'span',
												null,
												'Nấu ',
												this.state.recipe.recipe.cookTime,
												' phút ',
												_react2.default.createElement('i', { className: 'fa fa-clock-o' })
											) : null
										)
									...
									typeof this.state.recipe.recipe.note != 'undefined' && this.state.recipe.recipe.note != null ? _react2.default.createElement(
										'div',
										{ className: 'notes' },
										_react2.default.createElement(
											'h3',
								...
								_react2.default.createElement(
									'section',
									{ id: 'review-section', className: 'review-rating clearfix' },
									_react2.default.createElement(
										'header',
										{ className: 'clearfix' },
										_react2.default.createElement(
									...
									_react2.default.createElement(
										...
										_react2.default.createElement(
											...
											_react2.default.createElement('img', { src: this.state.current_user_avatar, width: '50', height: '50' }),
											_react2.default.createElement(
												'button',
												{ className: 'btn button-small button-orange-lighter', onClick: this.reviewModal.bind(this) },
...
},{"../actions/RecipeActions":10,"../helpers":45,"../stores/NavbarStore":53,"../stores/RecipeModalStore":57,"../stores/RecipeStore":58,"./RecipeModal":26,"./inc/AddRecipePhotoModal":30,"./inc/AddReviewModal":31,"./inc/AddedToCollection":32,"./inc/LikeButton":37,"./inc/RecipeHeaderCover":40,"./inc/RecipeSmall":42,"./inc/Review":43,"async":60,"moment":79,"react":"react","react-router":"react-router","underscore":"underscore"}],26:[function(require,module,exports){
'use strict';
...
var _RecipeModalActions = require('../actions/RecipeModalActions');
...
var RecipeModal = function (_React$Component) {
	_inherits(RecipeModal, _React$Component);

	function RecipeModal(props) {
		_classCallCheck(this, RecipeModal);

		var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(RecipeModal).call(this, props));

		_this2.state = _RecipeModalStore2.default.getState();
		_this2.onChange = _this2.onChange.bind(_this2);
		_this2.oneTime = false;
		return _this2;
	}
	...
	_createClass(RecipeModal, [{
		...
		value: function componentDidMount() {
			_RecipeModalStore2.default.listen(this.onChange);
			_RecipeModalActions2.default.getCategories();
		...
		key: 'checkboxControl',
		value: function checkboxControl() {
			if (document.createElement('svg').getAttributeNS) {
				var checkbxsCross, radiobxsFill, checkbxsCheckmark, radiobxsCircle, checkbxsBoxfill, radiobxsSwirl, checkbxsDiagonal, checkbxsList, pathDefs, animDefs;
				...
				(function () {
					...
					var controlRadiobox = function controlRadiobox(el, type) {
						var svg = createSVGEl();
						el.parentNode.appendChild(svg);
						el.addEventListener('change', function () {
							resetRadio(el);
					...
					var draw = function draw(el, type) {
						var paths = [],
						    pathDef,
						    animDef,
						...
						switch (type) {
							case 'cross':
								pathDef = pathDefs.cross;animDef = animDefs.cross;break;
							case 'fill':
								pathDef = pathDefs.fill;animDef = animDefs.fill;break;
							case 'checkmark':
								pathDef = pathDefs.checkmark;animDef = animDefs.checkmark;break;
							case 'circle':
								pathDef = pathDefs.circle;animDef = animDefs.circle;break;
							case 'boxfill':
								pathDef = pathDefs.boxfill;animDef = animDefs.boxfill;break;
							case 'swirl':
								pathDef = pathDefs.swirl;animDef = animDefs.swirl;break;
							case 'diagonal':
								pathDef = pathDefs.diagonal;animDef = animDefs.diagonal;break;
							case 'list':
								pathDef = pathDefs.list;animDef = animDefs.list;break;
						};
					...
					var resetRadio = function resetRadio(el) {
		...
		value: function dropzoneControl() {
			...
			this.myDropzone = new Dropzone('#dZUpload', {
				...
				success: function success(file, response) {
					...
					_RecipeModalActions2.default.changeMainPhoto(response);
				},
				removedfile: function removedfile(file) {
					_RecipeModalActions2.default.deleteImage($('#mainPhoto').val());
					var _ref;
					if (file.previewElement) {
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										'form',
										{ className: 'row', onSubmit: this.props.handleSubmit },
										_react2.default.createElement(
											'div',
												...
												_react2.default.createElement(
													...
													_react2.default.createElement(
														...
														_react2.default.createElement('input', {
															...
															onChange: _RecipeModalActions2.default.handleChanges
														})
													),
													_react2.default.createElement(
														'div',
												...
												_react2.default.createElement(
													...
													_react2.default.createElement(
														...
														_react2.default.createElement(_reactSelect2.default, {
															...
															onChange: _RecipeModalActions2.default.handleCategoryChange
														})
													)
												)
											)
											...
											_react2.default.createElement(
												...
												_react2.default.createElement(
													...
													_react2.default.createElement(
														'li',
														null,
														_react2.default.createElement('input', { id: 'r9', name: 'visible', type: 'radio', value: 'private', onChange: _RecipeModalActions2.default.handleChanges }),
														_react2.default.createElement(
															'label',
															{ htmlFor: 'r9' },
															'Bí mật ',
													...
													_react2.default.createElement(
														'li',
														null,
														_react2.default.createElement('input', { id: 'r10', name: 'visible', type: 'radio', value: 'public', defaultChecked: true, onChange: _RecipeModalActions2.default.handleChanges }),
														_react2.default.createElement(
															'label',
															{ htmlFor: 'r10' },
															'Công khai ',
...
},{"../actions/RecipeModalActions":11,"../stores/RecipeModalStore":57,"react":"react","react-select":87}],27:[function(require,module,exports){
'use strict';
...
},{"react":"react","react-star-rating-component":93}],31:[function(require,module,exports){
'use strict';
...
},{"react":"react","react-star-rating-component":93}],32:[function(require,module,exports){
'use strict';
...
var AddedToCollection = function (_React$Component) {
	_inherits(AddedToCollection, _React$Component);

	function AddedToCollection(props) {
		_classCallCheck(this, AddedToCollection);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(AddedToCollection).call(this, props));
	}

	_createClass(AddedToCollection, [{
		key: 'render',
		value: function render() {
			var avatar = _helpers2.default.fb_avatar(this.props.user.facebook.id, 80, 80);
			//let avatar ="#";
			return _react2.default.createElement(
				'div',
				{ className: 'added-to-collection', key: this.props.key },
				_react2.default.createElement(
					_reactRouter.Link,
					{ className: 'user', to: '/cook/' + this.props.user.username },
					_react2.default.createElement('img', { className: 'circle-img', src: avatar })
				),
				_react2.default.createElement(
					'div',
					{ className: 'info' },
					...
					_react2.default.createElement(
						_reactRouter.Link,
						{ to: this.props.collectionUrl, className: 'collection' },
...
},{"../../helpers":45,"react":"react","react-router":"react-router"}],33:[function(require,module,exports){
'use strict';
	...
	_createClass(AvatarUsername, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement('img', { style: imgStyle, src: avatar, width: size, height: size }),
				_react2.default.createElement(
					'span',
					{ style: nameStyle },
...
},{"../../helpers":45,"react":"react","react-router":"react-router"}],34:[function(require,module,exports){
'use strict';
...
var Breadcrumb = function (_React$Component) {
	...
	_createClass(Breadcrumb, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'nav',
				{ style: styles.master, className: 'Breadcrumb' },
				_react2.default.createElement(
					_reactRouter.Link,
					{ style: styles.a, to: '/' },
					'Trang chủ'
				...
				this.props.category ? _react2.default.createElement(
					'span',
					null,
					_react2.default.createElement(
						_reactRouter.Link,
						{ style: styles.a, to: '/category/' + this.props.category._id },
...
},{"../../helpers":45,"../../stores/NavbarStore":53,"moment":79,"react":"react","react-router":"react-router","react-star-rating-component":93,"underscore":"underscore"}],37:[function(require,module,exports){
'use strict';
...
var LikeButton = function (_React$Component) {
	...
	function LikeButton(props) {
		...
		if (props.likeState == 'like') {
			_this.state.likeLabel = 'Bỏ thích';
		} else {
			_this.state.likeLabel = 'Thích';
		}
		return _this;
	}
...
},{"react":"react","react-dom":"react-dom","react-router":"react-router","underscore":"underscore"}],39:[function(require,module,exports){
'use strict';
		...
		value: function render() {
			if (this.props.userLoggedIn) {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'a',
						{ className: 'nav-link', href: 'javascript:void(0)', onClick: _helpers2.default.facebookLogin },
						'Đăng nhập'
					)
				);
			}
...
},{"../../helpers":45,"react":"react","react-router":"react-router","underscore":"underscore"}],40:[function(require,module,exports){
'use strict';
...
var RecipeHeaderCover = function (_React$Component) {
	_inherits(RecipeHeaderCover, _React$Component);

	function RecipeHeaderCover(props) {
		_classCallCheck(this, RecipeHeaderCover);

		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RecipeHeaderCover).call(this, props));
	...
	_createClass(RecipeHeaderCover, [{
		key: 'componentWillReceiveProps',
		value: function componentWillReceiveProps(nextProps) {
			this.setState({
		...
		key: 'render',
		value: function render() {
			var recipeTime = (0, _moment2.default)(this.props.recipeTime);
			var coverStyle = {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement('div', { className: 'user-cover recipe-cover', style: coverStyle }),
				_react2.default.createElement(
					'div',
					{ className: 'container' },
					...
					_react2.default.createElement(
										...
										_react2.default.createElement(
											...
											_react2.default.createElement(
												...
												_react2.default.createElement(
													'span',
													{ className: 'bg' },
													_react2.default.createElement('i', { className: 'spoon' })
												),
												_react2.default.createElement(
													'span',
													{ className: 'number' },
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								{ className: 'userInfo' },
								typeof this.state.recipeOwner == 'undefined' ? null : _react2.default.createElement(
									_reactRouter.Link,
									{ to: '/cook/' + this.state.recipeOwner.username, className: 'avatar clearfix' },
									_react2.default.createElement('img', {
										src: 'http://graph.facebook.com/v2.5/' + this.state.recipeOwner.facebook.id + '/picture?height=80&width=80' }),
									_react2.default.createElement(
										'span',
										{ className: 'username' },
										this.state.recipeOwner.name
									)
								),
								_react2.default.createElement(
									'div',
	...
	return RecipeHeaderCover;
}(_react2.default.Component);

exports.default = RecipeHeaderCover;

},{"./Breadcrumb":34,"moment":79,"react":"react","react-router":"react-router"}],41:[function(require,module,exports){
'use strict';
...
var _AvatarUsername = require('./AvatarUsername');
...
var RecipeMedium = function (_React$Component) {
	_inherits(RecipeMedium, _React$Component);

	function RecipeMedium(props) {
		_classCallCheck(this, RecipeMedium);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(RecipeMedium).call(this, props));
	}

	_createClass(RecipeMedium, [{
		key: 'render',
		value: function render() {
			var imgUrl = '/images/df-img-sm.jpg';
			if (this.props.recipe.mainPhoto != null) {
				imgUrl = _helpers2.default.img_url(this.props.recipe.mainPhoto.metadata.thumbs.s320.id);
			}
			var recipeUrl = '/recipe/' + this.props.recipe.contentId;
			return _react2.default.createElement(
				'div',
				{ className: this.props.class, key: this.props.recipe._id.toString() },
				_react2.default.createElement(
					'div',
					{ className: 'photo' },
					_react2.default.createElement(
						_reactRouter.Link,
						{ to: recipeUrl },
						_react2.default.createElement('img', { src: imgUrl, width: '320', height: '320' })
					),
					_react2.default.createElement(
						_reactRouter.Link,
						{ state: { modal: true, returnTo: this.props.location.pathname }, className: 'ghim-btn', to: recipeUrl + '/ghim' },
						_react2.default.createElement('i', { className: 'fa fa-thumb-tack' }),
						_react2.default.createElement(
							'span',
							{ className: 'txt' },
				...
				_react2.default.createElement(
					'div',
					{ className: 'recipe-info' },
					_react2.default.createElement(_AvatarUsername2.default, { size: '40', owner: this.props.recipe.userId }),
					_react2.default.createElement(
						'h4',
						{ className: 'recipe-title' },
						_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						this.props.recipe.recipe.description
					),
					_react2.default.createElement(
						_reactRouter.Link,
						{ className: 'readmore', to: recipeUrl },
						'Xem cách làm'
					)
				)
			);
...
exports.default = RecipeMedium;

},{"../../helpers":45,"./AvatarUsername":33,"react":"react","react-router":"react-router","react-star-rating-component":93}],42:[function(require,module,exports){
'use strict';
...
var RecipeSmall = function (_React$Component) {
	_inherits(RecipeSmall, _React$Component);

	function RecipeSmall(props) {
		_classCallCheck(this, RecipeSmall);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(RecipeSmall).call(this, props));
	}
...
},{"../../helpers":45,"react":"react","react-router":"react-router","react-star-rating-component":93}],43:[function(require,module,exports){
'use strict';
...
},{"../../helpers":45,"../../stores/NavbarStore":53,"moment":79,"react":"react","react-router":"react-router","react-star-rating-component":93,"underscore":"underscore"}],44:[function(require,module,exports){
'use strict';
...
},{"../../../helpers":59,"react":"react","react-router":"react-router","underscore":"underscore"}],45:[function(require,module,exports){
'use strict';
...
module.exports = {
	...
	trim_words: function trim_words(text, length, more) {
	...
	masterMasonry: function masterMasonry() {
		$('.grid').masonry({
			columnWidth: '.grid-sizer',
			gutter: '.gutter-sizer',
			itemSelector: '.grid-item',
...
},{"history/lib/createHistory":72}],47:[function(require,module,exports){
'use strict';
...
},{"./routes":48,"history/lib/createBrowserHistory":70,"react":"react","react-dom":"react-dom","react-router":"react-router"}],48:[function(require,module,exports){
'use strict';
...
exports.default = _react2.default.createElement(
	...
	_react2.default.createElement(_reactRouter.Route, { path: '/khong-tim-thay', component: _NotFound2.default }),
...
},{"./components/App":13,"./components/AuthSuccess":14,"./components/Category":15,"./components/Collection":16,"./components/Ghim":18,"./components/Home":19,"./components/NotFound":21,"./components/Profile":22,"./components/ProfileCollections":23,"./components/ProfileRecipes":24,"./components/Recipe":25,"./components/Recipes":27,"react":"react","react-router":"react-router"}],49:[function(require,module,exports){
'use strict';
...
var CategoryStore = function () {
	function CategoryStore() {
		...
		this.bindActions(_CategoryActions2.default);
		this.category = {
			name: ''
		};
		this.recipes = [];
	...
	_createClass(CategoryStore, [{
		...
		key: 'onGetCategoryRecipesSuccess',
		value: function onGetCategoryRecipesSuccess(data) {
			this.recipes = data;
		}
	}]);
...
},{"../actions/CategoryActions":1,"../alt":12}],50:[function(require,module,exports){
'use strict';
...
},{"../actions/CollectionActions":2,"../actions/CommentFormActions":3,"../actions/NavbarActions":6,"../alt":12,"./NavbarStore":53,"underscore":"underscore"}],51:[function(require,module,exports){
'use strict';
...
},{"../actions/GhimActions":4,"../alt":12}],52:[function(require,module,exports){
'use strict';
...
var HomeStore = function () {
	...
	_createClass(HomeStore, [{
		...
		key: 'onGetRecipesSuccess',
		value: function onGetRecipesSuccess(data) {
			this.recipes = data;
		}
	}]);
...
},{"../actions/HomeActions":5,"../alt":12,"underscore":"underscore"}],53:[function(require,module,exports){
'use strict';
...
},{"../actions/NavbarActions":6,"../alt":12}],54:[function(require,module,exports){
'use strict';
...
},{"../actions/ProfileCollectionsActions":8,"../alt":12,"underscore":"underscore"}],55:[function(require,module,exports){
'use strict';
...
},{"../actions/ProfileRecipesActions":9,"../alt":12,"underscore":"underscore"}],56:[function(require,module,exports){
'use strict';
...
},{"../actions/ProfileActions":7,"../alt":12}],57:[function(require,module,exports){
'use strict';
...
var RecipeModalStore = function () {
	function RecipeModalStore() {
		_classCallCheck(this, RecipeModalStore);

		this.bindActions(_RecipeModalActions2.default);
		this.categories = [];
		this.formData = {
			visible: 'public',
			title: '',
	...
	_createClass(RecipeModalStore, [{
		...
		key: 'onChangeMainPhoto',
		value: function onChangeMainPhoto(id) {
			this.formData.mainPhoto = id;
		}
	}, {
		key: 'onGetRecipeFromParent',
		value: function onGetRecipeFromParent(data) {
			this.formData = {
			...
			if (data.mainPhoto != null && _typeof(data.mainPhoto) == 'object') {
	...
	return RecipeModalStore;
}();

exports.default = _alt2.default.createStore(RecipeModalStore);

},{"../actions/RecipeModalActions":11,"../alt":12,"underscore":"underscore"}],58:[function(require,module,exports){
'use strict';
...
var RecipeStore = function () {
	function RecipeStore() {
		...
		this.bindActions(_RecipeActions2.default);
		this.bindListeners({
			updateLikeState: _NavbarActions2.default.getMyInfoSuccess
		});
		this.recipe = {
	...
	_createClass(RecipeStore, [{
		...
		key: 'updateLikeState',
		value: function updateLikeState(data) {
			if (_underscore2.default.indexOf(this.recipe.loves, data._id) >= 0) {
				this.likeState = 'like';
			}
		}
	}, {
		key: 'onUpdateRecipeSuccess',
		value: function onUpdateRecipeSuccess(data) {
...
},{"../actions/NavbarActions":6,"../actions/RecipeActions":10,"../alt":12,"./NavbarStore":53,"underscore":"underscore"}],59:[function(require,module,exports){
'use strict';
...
},{"_process":81}],61:[function(require,module,exports){
/*!
...
},{"_process":81,"warning":94}],68:[function(require,module,exports){
'use strict';
...
},{"./Actions":65,"./DOMStateStorage":67,"./DOMUtils":68,"./ExecutionEnvironment":69,"./createDOMHistory":71,"./parsePath":76,"_process":81,"invariant":78}],71:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./DOMUtils":68,"./ExecutionEnvironment":69,"./createHistory":72,"_process":81,"invariant":78}],72:[function(require,module,exports){
...
module.exports = exports['default'];
},{"./Actions":65,"./AsyncUtils":66,"./createLocation":73,"./deprecate":74,"./parsePath":76,"./runTransitionHook":77,"deep-equal":62}],73:[function(require,module,exports){
//import warning from 'warning'
'use strict';
...
},{"./extractPath":75,"_process":81,"warning":94}],77:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":81,"warning":94}],78:[function(require,module,exports){
(function (process){
/**
...
module.exports = exports["default"];
},{"./HelmetConstants.js":83,"./PlainComponent":84,"deep-equal":62,"object-assign":80,"react":"react","react-side-effect":90}],83:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
    value: true
});
var TAG_NAMES = {
...
},{"classnames":61,"react":"react"}],87:[function(require,module,exports){
...
},{"./Option":86,"./SingleValue":88,"./Value":89,"classnames":61,"react":"react","react-dom":"react-dom","react-input-autosize":85}],88:[function(require,module,exports){
'use strict';
...
},{"classnames":61,"react":"react"}],89:[function(require,module,exports){
'use strict';
...
},{"classnames":61,"react":"react"}],90:[function(require,module,exports){
'use strict';
...
},{"fbjs/lib/ExecutionEnvironment":91,"fbjs/lib/shallowEqual":92,"react":"react"}],91:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"classnames":61,"react":"react"}],94:[function(require,module,exports){
(function (process){
/**
