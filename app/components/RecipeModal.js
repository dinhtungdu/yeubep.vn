...
class RecipeModal extends React.Component {
	...
	componentDidMount() {
		...
		RecipeModalActions.getCategories();
									...
									<form className="row" onSubmit={this.props.handleSubmit}>
												...
												<div className="col-lg-6">
													<div className="form-group">
														...
														<input
															...
															onChange={RecipeModalActions.handleChanges}
														/>
													</div>
													<div className="form-group">
										...
										<div className="col-sm-8 big-col">
											...
											<div className="form-group ac-custom ac-radio ac-fill">
												<ul>
													<li><input id="r9" name="visible" type="radio" value="private" onChange={RecipeModalActions.handleChanges} /><label htmlFor="r9">Bí mật <span className="sublabel">Chỉ bạn mới xem được công thức này</span></label></li>
													<li>
														<input id="r10" name="visible" type="radio" value="public" defaultChecked onChange={RecipeModalActions.handleChanges} /><label htmlFor="r10">Công khai <span className="sublabel">Tất cả mọi nguời đều xem được.</span></label>
